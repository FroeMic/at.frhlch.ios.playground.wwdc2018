...
extension PipeTopAsset {
    ...
    public class func yellowPipe(offsetX: CGFloat, height: CGFloat) -> PipeTopAsset {
        return PipeTopAsset(assetUrl: "pipe_top_yellow.png", offsetX: offsetX, height: height)
    }
